...
public class AppointmentController {
	...
	public String updateApp(@Validated @PathVariable("id") long id, @RequestParam(value = "action", required = true)String action,
			Appointment app,  BindingResult bindingResult)
	{
		if (!action.equals("Cancel")) {
			if(bindingResult.hasErrors())
			{
